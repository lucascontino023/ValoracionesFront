<template>
  <div class="container mx-auto pt-3">
    <div class="pb-5 ml-3">
      <h1 class="text-3xl text-green-400 font-semibold">Valoraciones del producto</h1>
      ...
      <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-start">
        <div v-for="(item, i) in arrayInicialSeteado" :key="i" class="border p-3 m-2">
